...
from machin.machin.frame.algorithms import DQNApex
from machin.machin.parallel.distributed import World
...
def main(rank):
    ...
    dqn_apex = DQNApex(
        q_net, q_net_t, t.optim.Adam, nn.MSELoss(reduction="sum"), apex_group, servers
    )
