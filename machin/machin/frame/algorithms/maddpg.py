...
from machin.machin.utils.visualize import make_dot
from machin.machin.utils.logging import default_logger
from machin.machin.model.nets.base import static_module_wrapper
from machin.machin.parallel.pool import P2PPool, ThreadPool
from machin.machin.frame.transition import Scalar
        ...
        if not hasattr(model, "input_device") or not hasattr(model, "output_device"):
            ...
            if len(device) > 1:
                raise RuntimeError(
                    ...
                    1. static_module_wrapper from machin.machin.model.nets.base
                    2. dynamic_module_wrapper from machin.machin.model.nets.base 
                    
                    Or construct your own module & model with: 
                    NeuralNetworkModule from machin.machin.model.nets.base"""
                )
            else:
