...
class ReplayBuffer(object):
    ...
    def push(self, observations, actions, rewards, next_observations, dones):
        nentries = len(observations['agent 0'])  # handle multiple parallel environments
        ...
        for agent_i in range(self.num_agents):
            ...
            self.obs_buffs[agent_i][self.curr_i:self.curr_i + nentries] = observations[f'agent {agent_i}']
            ...
            self.next_obs_buffs[agent_i][self.curr_i:self.curr_i + nentries] = next_observations[f'agent {agent_i}']
